...
/**
 * Abstract class to convert byte arrays to longs for
 * encrypting 64 bit byte arrays as longs.
 */
public abstract class BlockCipher64
{
    /**
     * Encrypt a block of plaintext using the given key.
     * The block size is 64 bits.
     * The length of the key and the block must be eight bytes.
     *
     ...
     * The block size is 64 bits.
     *
     * @param key   the encryption key as a long
     * @param block the block to encrypt (plaintext) as a long
     ...
     * The block size is 64 bits.
     *
     * @param key   the decryption key as a long
     * @param block the block to decrypt (ciphertext) as a long
